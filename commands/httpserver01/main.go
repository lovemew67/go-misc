...
import (
	...
	"github.com/lovemew67/go-misc/commands/httpserver01/handlerv1"
...
func NewAPIServerCmd() *cobra.Command {
	...
	var apiServerCmd = &cobra.Command{
		Use:   "httpserver01",
		Short: "start the restful api server - http server 01",
		Long:  `run the web api server by given config - http server 01`,
